...
function on_recently_closed_click() {
  ...
  if (opened) {
    ...
    var removeEscHandler = addEscHandler(close);
...
function close(e) {
    ...
    if (e && e.target && e.target.id == 'recently-closed-clear-button')
      clear();
  }
...
window.on_recently_closed_click = on_recently_closed_click;
